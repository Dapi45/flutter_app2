...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Tugas Mobile Programming Daffi Fadillah 20200120030 TI-IS 1/4',
      theme: ThemeData(
      ...
      initialRoute: '/awal',
      routes: {
        '/awal': (context) => const MyHomePage(title: 'Halaman Awal'),
        '/hal1': (context) => const FirstPage(title: 'Halaman Pertama'),
        '/hal2': (context) => const SecondPage(title: 'Halaman Kedua'),
        '/hal3': (context) => const ThirdPage(title: 'Halaman Ketiga'),
      },
    );
  }
}
